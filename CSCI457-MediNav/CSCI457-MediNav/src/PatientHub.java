...
public class PatientHub implements ActionListener {
	...
	public static void main(String[] args) {
		new PatientHub("patient");
	}

	public PatientHub(String portal) {
		// Frame
		this.window = new JFrame("Find Your Doctor");
		...
		// Background Image
		this.titleImage = new ImageIcon(getClass().getClassLoader().getResource("PatientPortal.png"));
